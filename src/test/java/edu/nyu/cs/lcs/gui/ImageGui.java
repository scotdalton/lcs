...
public class ImageGui {
	...
	public static void main(String[] args) throws Exception {
		...
		images.put("Image 1", image1);
		images.put("Image 1 Classification", image1.getClassificationImage());
		final Map<String, Image> finalImages = Collections.unmodifiableMap(images);
